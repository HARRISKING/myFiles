        ...
        var success = function(data) {
            ...
            wx.request({
                ...
                success:function(res){
                    ...
                    var locationAll2= data.result.location.lat + ',' + data.result.location.lng;
                    ...
                    wx.request({
                        ...
                        success: function(res) {
                            console.log(res);
                            var urlPlus = 'http://apis.map.qq.com/ws/geocoder/v1/?key=XFRBZ-NA7K3-UZK3C-YNGNZ-JG3EH-PHBCQ&location='+locationAll2;
